...
<html lang="fr">
	<head>
		<title>Kezako - Supprimer Question</title>
		<meta name="keywords" lang="fr" content="kezako,supprimer" />
		...
		<div class="container main">
			<div class="container-fluid">
				<div class="page-header">
					<h1>Supprimer des questions</h1>
				</div>
				
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4>Liste des questions validées</h4>
					</div>
									...
									<tbody id="table">
										<?php
											...
											while ($row = $questions->fetch_row()) {
												...
												echo"<td><button onclick=\"supprimer(".$row[0].");\" class=\"btn btn-primary\"><span class=\"glyphicon glyphicon-play\"></span> Supprimer</button></td>  
												</tr>";
	...
	<script type="text/javascript">
		...
		{
			$.ajax({
				  url: "supprimerquestion2.php?id="+id,
				  type : 'GET',
				  async: true,
				  dataType: "text",
